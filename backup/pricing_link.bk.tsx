...
const Subscription = ({
  ...
  const openCheckoutPage = (pricing) => {
    ...
    if (userData && userData.data && userData.data.user_id) {
      ...
      if (!redirectTo) {
        redirectionAction("PRICING"); // after sign in redirect to subscription page
      }
          ...
          <div className="container">
            <div className="plans-block">
              <div className="heading">
                ...
                <p>Enroll now and take a step ahead to level up your career!</p>
              </div>
              <div className="choose-plans">
                <div className="title">Choose your Subscription plan</div>
                  ...
                  {subscriptionData.map((item) => (
                    <div className="block" key={item.id}>
                      ...
                      <ul>
                        ...
                        <li className={item.is_premium_support ? "active" : ""}>Premium Support</li>
                      </ul>
                      <button
