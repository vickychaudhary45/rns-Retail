        ...
        <div className="container-small">
          <div className="breadcrumbs">
            <ul>
              ...
              <li>
                <Link legacyBehavior  href="/devops#devOps">
                  <a>DevOps Services</a>
                </Link>
              </li>
              <li>
...
export async function getServerSideProps({ params }) {
  const ftPageResp = await axios.post(`${baseUrl}/courses/ft`, { slug: "devops/" + params.slug });
...
export default connect(mapStateToProps, mapDispatchToProps)(DevOpsFT);
