        ...
        <div className="container-small">
          <div className="breadcrumbs">
            <ul>
              ...
              <li>
                <Link legacyBehavior  href="/gcp#google">
                <a >GCP Web Services</a>
                </Link>
              </li>
              <li>
...
export async function getServerSideProps({ params }) {
  const ftPageResp = await axios.post(`${baseUrl}/courses/ft`, { slug: "gcp/" + params.slug });
...
export default connect(mapStateToProps, mapDispatchToProps)(GCPFT);
