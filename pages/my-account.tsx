...
export async function getServerSideProps(context) {
  ...
  if (userToken) {
    ...
    // if (
    //   profile &&
    //   ((profile.country_id && profile.state_id) || (profile.city && profile.city.state_id))
    // ) {
    ...
    //     baseUrl + "/data/cities/" + (profile.state_id ? profile.state_id : profile.city.state_id)
    //   );
