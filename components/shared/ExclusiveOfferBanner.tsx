...
const ExclusiveOfferBanner = ({closeBanner,bannerStatus}) => {
      ...
      <div className="container">
        <div className="left-block">
          <div className="annual-text">
            <span>EXCLUSIVE OFFER </span>Flat 20% off
          </div>
        </div>
          ...
          <div className="plan-group">
            <div className="box">
              <div className="price-block">
                <span className="price">US $39</span>
                <del className="old-price">US $49</del>
              </div>
            ...
            <div className="box">
              <div className="price-block">
                <span className="price">US $119</span>
                <del className="old-price">US $149</del>
              </div>
