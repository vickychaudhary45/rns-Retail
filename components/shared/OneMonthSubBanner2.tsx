...
const OneMonthSubBanner2 = () => {
  ...
  return (
    <div className="bottom-up-skilling bottom-banner" style={{ display: bannerStatus ? "block" : "none" }}>
      <div className="container">
        <div className="up-skill-gorup">
          <label>Explore unlimited resources</label>
          <strong>For Your Upskilling</strong>
          <figure className="sharp">
            <img className="img-full" src="/images/up-skill.svg" />
          </figure>
        </div>
        <div className="right-side">
          <div className="sub-group">
            <div className="box">
              <label>Try 1-Month</label>
              <strong>Premium Subscription</strong>
            </div>
            <div className="box">
              <label>For the first month</label>
              <div className="price-box">
                <span className="price">
                  <strong>at just $9</strong>
                </span>
          ...
          <div className="btn-coupon">
            <div className="coupon">
              ...
              <div className="code">WHIZ9SUB</div>
            </div>
...
export default OneMonthSubBanner2;
