...
const ValentineOffer = () => {
  ...
  return (
    <div
      className="bottom-valentine bottom-banner"
      style={{ display: bannerStatus ? "block" : "none" }}
    >
      <div className="container">
        <div className="left-block">
          <figure>
            <img className="img-full" src="/images/valentine-bottom.svg" />
          </figure>
        </div>
        <div className="right-block">
          <div className="flat-box-group">
            <div className="box-group">
              ...
              <div className="code-box">
                ...
                <div className="code">whiz40vd</div>
            ...
            <div className="box-group">
              ...
              <div className="code-box">
                <label>Use Coupon</label>
                <div className="code">whiz30vd</div>
          ...
          <div className="main-timer">
            <div className="count">
              <div className="colon">
                <div id="daytime2" className="daytime2">{value.d}</div>
                <span>:</span>
              </div>
              <label>days</label>
            </div>
            <div className="count">
              <div className="colon">
                <div id="hourtime2" className="hourtime2">{value.h}</div>
                <span>:</span>
              </div>
              <label>hours</label>
            </div>
            <div className="count">
              <div className="colon">
                <div id="minutetime2" className="minutetime2">{value.m}</div>
                <span>:</span>
              </div>
              <label>mins</label>
            </div>
            <div className="count">
              <div className="colon">
                <div id="secondtime2" className="secondtime2">{value.s}</div>
                <span></span>
              </div>
              <label>sec</label>
            </div>
