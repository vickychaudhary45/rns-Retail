...
const BannerWomensDayBottom = () => {
  ...
  return (
    <div
      className="bottom-women-day bottom-banner"
    ...
    >
      <div className="container">
        <div className="left-block">
          ...
          <figure>
            <img className="img-full" src="/images/woment-bottom.png" />
          </figure>
        </div>
          ...
          <div className="flat-box-group">
            <div className="box-group">
              ...
              <div className="code-box">
                ...
                <div className="code">WHIZWOMEN40</div>
            ...
            <div className="box-group">
              ...
              <div className="code-box">
                <label>Use Coupon</label>
                <div className="code">WHIZWOMEN30</div>
...
export default BannerWomensDayBottom;
