...
const PricingCard = ({ plan_data,currentPlan,disableButton,openCheckoutPage,userData,buttonClickAction,planType,alertBoxAction}) => {
    ...
    <>
      <div style={{ margin: "0" }}>
        ...
        id="pricing_card">
          ...
          <div className={styles.inner_box}>
            ...
            <div id={plan_data.type == "subs" ?"valuebox":"valueboxE"}>
              <div className={styles.value}>
                        ...
                        1 ? (
                          ...
                          <>
                            ...
                            >
                              <span className={`${styles.strike} ${styles.campaign}`}>
                                $
                                {(plan_data.offer_price.usd / plan_data.subscription_for).toFixed(
                                  2
                                )}
                              </span>
                              <span className={`${styles.campaign}`}>/</span>
                ...
                {
                plan_data.type == 'subs' && <div className={styles.pricinginfo}>
                { plan_data.campaign_offer ? (
                  <>
                    ${parseFloat(plan_data.campaign_offer.price.usd).toFixed(2)} billed for the 1st
            ...
            {/* <div className={styles.subplanname}>{plan_data.subInfo.plan_desc}</div> */}
          ...
          <div className={`pricing-block ${styles.pricing_block_mobile}`} style={{ padding: "0px", background: "white" }}>
